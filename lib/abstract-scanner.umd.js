...
function includes(arr, searchElement) {
    return arr.some(function (element) { return element === searchElement; });
}
...
function isOctalDigit(cp) {
    return (cp >= 0x30 && cp <= 0x37); // 0..7
}
exports.isOctalDigit = isOctalDigit;
function isBinaryDigit(cp) {
...
var NonAsciiIdentifierStartRanges = [
...
var NonAsciiIdentifierPartRanges = [
...
var utils = __webpack_require__(1);
exports.utils = utils;
var abstract_scanner_1 = __webpack_require__(2);
